...
Evaluated on a held-out test set of sequences not used for training,
...
ROC-AUC is reported as the headline metric because it is threshold-free and
robust to the heavy class imbalance between quiet and flare sequences.
